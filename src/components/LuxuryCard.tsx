...
const LuxuryCard: React.FC<{ deal: Deal }> = ({ deal }) => {
  // Ensure that originalPrice and price exist before calculating discount
  const discount =
    deal.originalPrice && deal.price
      ...
      : 0; // Fallback to 0 if missing data

  return (
    <div className="luxury-card">
      <div className="image-container">
        <img src={deal.image || "/placeholder.svg"} alt={deal.destination} />
